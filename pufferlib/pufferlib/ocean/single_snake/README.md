# PufferLib Single Snake

This variant is pinned to a single snake, a single food item, a 10x10 playable map, and vision radius 10. It keeps the same pufferlib C binding/vector API as the original snake environment, but strips configuration complexity for a minimal training setup.
